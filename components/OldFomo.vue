<template>
    <div :class="classname">
      <div class="z-[999] bg-white p-6 rounded shadow-2xl text-left">
        <h1 class="z-[999]text-sm md:text-sm lg:text-sm xl:text-sm text-blue-800 font-normal">{{ ds[index].name }} in <span class="font-semibold">{{ ds[index].country }}</span> subscribed</h1>
    ...
    props: {
        ds: {
            ...
            default: () => [
                ...
                {name: "Paul", country: "🇺🇸 United States"},
                {name: "Alex", country: "🇩🇪 Germany"},
                {name: "Kevin", country: "🇩🇪 Germany"},
            ],
            validator: (array) => {
